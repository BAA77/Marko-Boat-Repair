...
window.addEventListener("scroll", () => {
    ...
    let heroText = document.querySelector(".hero-page-h2");
...
// did you know
let dKnowCon = document.querySelector(".know-con");
setInterval(() => {
    let dKnow = document.querySelectorAll(".know");
    dKnowCon.appendChild(dKnow[0]);
}, 10000);
